...
public class Passengerlogin extends javax.swing.JFrame {
  ...
  Connection con = null;
    ...
    private void initComponents() {
        ...
        lblclick.setFont(new java.awt.Font("Tahoma", 3, 16)); // NOI18N
        lblclick.setForeground(new java.awt.Color(255, 255, 255));
        lblclick.setText("Click here to signup");
        lblclick.setToolTipText("Click here to signup");
        ...
        jLabel7.setText("Search Tickets(Log in not recquired)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(pwd.equalsIgnoreCase("olopcs")&& name.equalsIgnoreCase("olopcs")){
         ...
         try
          ...
          Connection   con = DriverManager.getConnection("jdbc:mysql://localhost","root","olopcs");                
            ...
            stmt.executeUpdate(quer);
                String query = "select * from signup where Username = '"+name+"' and "+"password = '"+pwd+"';";
...
//                    
    ...
    private void lblclickMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblclickMouseEntered
        // TODO add your handling code here:
        lblclick.setText("<html><u>Click here to signup</u></html>");
...
jLabel7.setText("<html><u>Search Tickets(Log in not recquired)</u></html>");
        // TODO add your handling code here:
