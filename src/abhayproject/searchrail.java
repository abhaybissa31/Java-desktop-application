 ...
 * @author Vishal
 */
public class searchrail extends javax.swing.JFrame {
 ...
 Connection con = null;
        ...
        ResultSet rs = null;
         try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost","root", "abhay");
    ...
    private void initComponents() {
        ...
        tb.setForeground(new java.awt.Color(44, 62, 80));
        ...
        tb.setOpaque(false);
        tb.setSelectionBackground(new java.awt.Color(44, 62, 80));
        tb.setSelectionForeground(new java.awt.Color(44, 62, 80));
...
public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new searchrail().setVisible(true);
            }
        });
    }
